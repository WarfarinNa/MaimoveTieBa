...
优先使用chat\_stream，如果没有则使用chat\_id直接查找。
...
## 回复集合`reply_set`格式 [​](#回复集合reply-set格式)
...
[Previous pageLLM API](/develop/plugin_develop/api/llm-api.md)

[Next page表情包API](/develop/plugin_develop/api/emoji-api.md)