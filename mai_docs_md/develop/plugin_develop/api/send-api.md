...
### 1. 基础文本发送，并回复消息 [​](#_1-基础文本发送-并回复消息)
...
[Previous page依赖管理](/develop/plugin_develop/dependency-management.md)

[Next page消息API](/develop/plugin_develop/api/message-api.md)