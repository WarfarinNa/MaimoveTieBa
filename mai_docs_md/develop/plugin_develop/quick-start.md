...
### 2. 创建`_manifest.json`文件 [​](#_2-创建-manifest-json文件)
...
![1750326700269](/assets/1750326700269.O4MUaJar.png)

### 5. 添加第一个功能：问候Action [​](#_5-添加第一个功能-问候action)
...
![1750332508760](/assets/1750332508760.C4j-Rdtf.png)

> **💡 小提示**：MaiCore会智能地决定什么时候使用它。如果没有立即看到效果，多试几次不同的消息。

🎉 太棒了！你的插件已经有实际功能了！

### 7. 添加第二个功能：时间查询Command [​](#_7-添加第二个功能-时间查询command)
...
### 8. 测试时间查询Command [​](#_8-测试时间查询command)
...
[Previous page开发指南](/develop/plugin_develop/)

[Next pageManifest系统指南](/develop/plugin_develop/manifest-guide.md)