...
### `ConfigField`：配置项的基石 [​](#configfield-配置项的基石)
...
[Previous page工具系统](/develop/plugin_develop/tool-components.md)

[Next page依赖管理](/develop/plugin_develop/dependency-management.md)